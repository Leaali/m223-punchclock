...
public class TagController {
    ...
    @Operation(summary = "Update an tag", description = "Updates an tag with the specified ID and returns the updated tag.")
    ...
    @DELETE
    @Path("/{id}")
    @Operation(summary = "Delete an tag", description = "Deletes an tag with the specified ID.")
